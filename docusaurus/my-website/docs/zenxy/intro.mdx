...
![ZenXY V2](https://cdn.shopify.com/s/files/1/1566/2831/files/PXL_20211029_205417321_1024x1024.jpg?v=1635739079)
...
![ZenXY v2 Render](/img/old/2021/03/XZXY-V2F-squarer.jpg)
...
![Sandify](/img/old/2019/01/screenshot-2019-01-02-1546472560.png)
...
If your glass is not mounted planar to your corners you can use a second magnet and stack them to reach your glass.
...
| Y Rail Larger Diameter [Calc](calculator)     | 2    |
| X Rail Smaller Diameter [Calc](calculator)    | 2    |
...
| [GT2 10mm Belt](https://www.v1e.com/collections/zenxy/products/gt2-10mm-belt)                    | [Calc](calculator)    |
...
The Y endstop is triggered along the larger diameter tube. The X is the other one 😄.

## Example Table

![Fusion CAD Render](/img/ZenTablev14.png)
