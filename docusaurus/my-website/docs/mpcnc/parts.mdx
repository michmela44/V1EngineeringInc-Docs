...
* Use the [calculator](calculator) to determine belt length.
...
*While you can use your 6mm belt, I suggest you upgrade to 10mm belt. Use the [calculator](calculator) for the amount you need.
