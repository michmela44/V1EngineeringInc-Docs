---
title: Introduction to The MPCNC
sidebar_position: 1
---

# This is an Inexpensive CNC Platform

![MPCNC Render](/img/old/2020/06/Primo-scaled.jpg)
...
- The linear motion is ball bearings on electrical conduit (or stainless steel)… seriously, easy to use and source. If this machine isn't big enough I have also designed the [LowRider CNC](/lowrider/intro), all the same specs and resolution just designed to be bigger!
...
- This is all controlled by any control board you like. 5 drivers are preferred, but a minimum of 3 is required. [Marlin](https://github.com/MarlinFirmware/Marlin), [GRBL](https://github.com/grbl/grbl), and Just about any firmware will work.
...
- Besides using either common imperial or metric hardware as listed, the rest of the machine is easily 3D printable, RepRap style! A full list of required hardware can be found on the [parts page](parts), and the files for the printed parts can be had there as well.
