...
![MPCNC Render](/img/old/2018/10/renb1-1.jpg)
...
* The [Bundle](https://www.v1e.com/collections/parts) has all the hardware and electronics except the conduit/rails which are cheaper to source locally than to ship – $271 + shipping if international.
...
* Tool. Either a [Dewalt](https://amzn.to/1MoBSQq), [import spindle](https://amzn.to/2arEPEg) or an extruder (3D Printer) $53, or anything else you might want to bolt on, laser, [drag knife](https://www.v1e.com/collections/parts/products/drag-knife-vinyl-cutter), foam cutting needle (awesome), etc.

Total Cost… if you have a 3D printer **Under $370**, $475 if you buy the printed parts from here.

**There is no other machine more versatile than the Mostly Printed CNC at any price point.**
...
- The linear motion is ball bearings on electrical conduit (or stainless steel)… seriously, easy to use and source.
...
- Besides using either common imperial or metric hardware, the rest of the machine is easily 3D printable, RepRap style! Full list of hardware on the [parts page](parts), and the files for the printed parts can be had [here](https://www.thingiverse.com/thing:724999).
...
![Simple MPCNC](/img/old/2015/07/IMG_20150802_16352001.jpg)
![Fancy MPCNC](/img/old/2018/04/IMG_20180409_184626.jpg)
